package com.eis.vathandroid.rendering
...
import com.eis.vathandroid.rawdepth.DepthData
import com.eis.vathandroid.rendering.ShaderUtil.checkGLError
import com.eis.vathandroid.rendering.ShaderUtil.loadGLShader
...
class DepthRenderer {
    ...
    fun createOnGlThread(context: Context?) {
        ...
        checkGLError(TAG, "Init complete")
    }
    ...
    fun update(points: FloatBuffer) {
        ...
        GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, 0)
        checkGLError(TAG, "Update complete")
    }
    ...
    fun draw(camera: Camera) {
        ...
        GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, 0)
        checkGLError(TAG, "Draw complete")
    }
    ...
    companion object {
        ...
        private const val BYTES_PER_POINT = BYTES_PER_FLOAT * DepthData.FLOATS_PER_POINT
